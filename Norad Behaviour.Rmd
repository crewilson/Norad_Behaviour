...
# Reward in block
ggplot(Trials, aes(x=bTrial,y=bRew)) + 
    geom_smooth(aes(colour=monkey), size=3,alpha = 0.5)+
    #geom_errorbar(aes(ymin=SameRT-se, ymax=SameRT+se), width=.1) +
    ggtitle("Rewards in block") +
...
# Shift in block
ggplot(Trials, aes(x=bTrial,y=Shift)) + #What data to plot
    geom_smooth(aes(colour=monkey), size=3,alpha = 0.5)+
    #geom_errorbar(aes(ymin=SameRT-se, ymax=SameRT+se), width=.1) +
    ggtitle("Shifts in block") +
    theme(plot.title = element_text(hjust = 0.5)) +
    ylab("Shifts") +
    xlab("Trials in block")  
    theme_bw()
...
ggplot(S1, aes(x=bTrial,y=COR)) + #What data to plot
    ...
    theme_bw() +
    ggtitle("Rewards and optimal choices within block") +
    theme(plot.title = element_text(hjust = 0.5)) +
    ylab("Proportion") +
    xlab("Trials in block")  
