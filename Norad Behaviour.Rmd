...
Trials <- subset(Trials, Nt!=1) # Remove trials with no response...
...
ggplot(S1, aes(x=bTrial,y=COR)) + #What data to plot
    geom_line(size=3,alpha = 0.5, colour="blue")+ 
    geom_errorbar(aes(ymin=COR-se, ymax=COR+se), width=.1) +
    geom_line(data=S2, aes(x=bTrial,y=Rew), size=3,alpha = 0.5, colour="green")+ 
    geom_errorbar(data=S2, aes(x=bTrial,y=Rew, ymin=Rew-se, ymax=Rew+se), width=.1) +
    geom_line(data=S3, aes(x=bTrial,y=Shift), size=3,alpha = 0.5, colour="red")+ 
    geom_errorbar(data=S3, aes(x=bTrial,y=Shift, ymin=Shift-se, ymax=Shift+se), width=.1) +
    theme_bw() +
...
# %C and % R across blocks within session
...
ggplot(SS1, aes(x=block,y=COR)) + #What data to plot
    geom_line(size=3,alpha = 0.5, colour="blue")+ 
    geom_errorbar(aes(ymin=COR-se, ymax=COR+se), width=.1) +
    geom_line(data=SS2, aes(x=block,y=Rew), size=3,alpha = 0.5, colour="green")+ 
    geom_errorbar(data=SS2, aes(x=block,y=Rew, ymin=Rew-se, ymax=Rew+se), width=.1) +
    geom_line(data=SS3, aes(x=block,y=Shift), size=3,alpha = 0.5, colour="red")+ 
    geom_errorbar(data=SS3, aes(x=block,y=Shift, ymin=Shift-se, ymax=Shift+se), width=.1) +
    theme_bw() +
